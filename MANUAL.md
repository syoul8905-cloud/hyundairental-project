...
[1단계: 종료 계기판 입력]
  시작 계기판: 71,298 km
  종료 계기판: [ 71,313 ] km 입력
  ➔ 오늘 실주행거리: 15 km 자동 계산!

[2단계: 주소지별 주차비 · 주유비 개별 입력 (★ 중요)]
  총액으로 뭉뚱그리지 않고, 비용이 발생한 고객사나 주유소 주소지마다 각각 입력:
  - #1 현대백화점 중동점: 주차비 [ 3,000 ] 원
  - 도착 가산 센터: 주유비 [ 50,000 ] 원
  ➔ 상단 배너에 자동 합산 (주차: 3,000원 / 주유: 50,000원) 및 운행일지 배송지별 행에 정확히 분배 기록!

[3단계: [오늘 운행일지 저장 및 마감] 원클릭]
  ➔ 법인차량 운행일지 시스템으로 당일 경유지별 주행거리 및 개별 주차비/주유비 일괄 전송 완료!
```
...
- **③ `[+ 배송지 직접 추가]` 버튼**: 하단 목록 우측의 파란색 버튼으로 당일 긴급 수기 주문 즉시 등록
